...
public static class UserEndpoints
{
  public static void MapUserEndpoints(this IEndpointRouteBuilder routes)
  {
    ...
    group.MapGet("/", async (IUserService userService) => { return Results.Ok(await userService.GetAllUsersAsync()); })
    ...
    group.MapPost("/", async (CreateUserRequest request, IUserService userService) =>
      {
        try
        {
          var createdUser = await userService.CreateUserAsync(request, request.Password);
